...
> Connor King, Casey-Tyler Berezin, Sarah I. Hernandez, Miranda Nowak, Jean Peccoud (Colorado State University).
...
- `Markdown1-Transfection_Rate_Constant_vs_Size.Rmd` — RMarkdown analysis testing whether the transfection/entry rate depends on plasmid size; runs regression + diagnostics and outputs summary tables/figures.
- `Markdown2-Coexpression_Level_Analysis.Rmd` — RMarkdown analysis of co-expression metrics (e.g., double/triple-positive fractions, correlation of reporters) for single vs. multi-plasmid conditions.
